...
```
 ...
 Específicamente hablando de la dispersión de los datos, independientemente de su mejoría o desmejoría a nivel de goles, notemos que en estos tres equipos hubieron 2 de 3 (Friburgo y Leverkusen) que aumentaron su desviación estándar con respecto a su media.  

* En el caso de Friburgo en pocas palabras, su concentración de datos pasó a encontrarse entre 0 y 1 goles, y sus datos atípicos más altos están entre 3 y 4 goles.
* En el caso de Leverkusen, su concentración de datos se mantuvo entre 1 y 2 goles, y hubo varios datos atípicos para la muestra, entre 4 y 5 goles.
 ...
 Lo curioso de este caso es que 2 de los 3 equipos (Eintracht y Leverkusen) evaluados en términos de goles han superado sus valores de posición y por consiguiente su media, se dice que después de la inclusión del VAR les fue mejor anotando goles “válidos”.  
 Por otra parte el otro equipo (Friburgo) se vió afectado y disminuyó estas estadísticas, tras la inclusión del VAR se fue peor anotando goles “válidos”.

### Tabla de Posiciones - Bundesliga

 Estos casos tan “inesperados” inicialmente, de mejoría en estos 2 equipos, se deben a que eran equipos que venían de tener una temporada 2016-17 mala, pues habían quedado por detrás del 10mo lugar de toda la liga. Para en la entrante superar al menos 3 posiciones, quedando por arriba del 9no lugar.

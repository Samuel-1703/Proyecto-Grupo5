...
```{r Tortas_Ptos, echo=FALSE}
  #agrupando tortas a 1×2
par(mfcol = c(1, 2))

  #gráfico de torta (Burnley)
pie(x = c(Burnley_15$Porcentaje_Por_Partido, Burnley_16$Porcentaje_Por_Partido),
    labels = c("", ""),
    col = c("green", "orange"),
    main = "% Puntos Obtenidos (Burnley)")
text(0.4, 0.4, paste0(Burnley_15$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)
text(0.0, -0.4, paste0(Burnley_16$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)

legend("topright", legend = c("2014-15", "2015-16"), fill = c("green", "orange"))

  #gráfico de torta (QPR)
pie(x = c(QPR_15$Porcentaje_Por_Partido, QPR_16$Porcentaje_Por_Partido),
    labels = c("", ""),
    col = c("green", "orange"),
    main = "% Puntos Obtenidos (QPR)")
text(0.3, 0.4, paste0(QPR_15$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)
text(0.0, -0.4, paste0(QPR_16$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)

legend("topright", legend = c("2014-15", "2015-16"), fill = c("green", "orange"))

  #gráfico de torta (Hull)
pie(x = c(Hull_15$Porcentaje_Por_Partido, Hull_16$Porcentaje_Por_Partido),
    labels = c("", ""),
    col = c("green", "orange"),
    main = "% Puntos Obtenidos (Hull)")
text(0.3, 0.4, paste0(Hull_15$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)
text(0.0, -0.4, paste0(Hull_16$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)

legend("topright", legend = c("2014-15", "2015-16"), fill = c("green", "orange"))

  #gráfico de torta (Bournemouth)
pie(x = c(Bournemouth_15$Porcentaje_Por_Partido, Bournemouth_16$Porcentaje_Por_Partido),
    labels = c("", " "),
    col = c("green", "orange"),
    main = "% Puntos Obtenidos (Bournemouth)")
text(-0.3, 0.2, paste0(Bournemouth_15$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)
text(0.3, -0.4, paste0(Bournemouth_16$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)

legend("topright", legend = c("2014-15", "2015-16"), fill = c("green", "orange"))

  #gráfico de torta (Norwich)
pie(x = c(Norwich_15$Porcentaje_Por_Partido, Norwich_16$Porcentaje_Por_Partido),
    labels = c("", " "),
    col = c("green", "orange"),
    main = "% Puntos Obtenidos (Norwich)")
text(-0.3, 0.2, paste0(Norwich_15$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)
text(0.4, -0.2, paste0(Norwich_16$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)

legend("topright", legend = c("2014-15", "2015-16"), fill = c("green", "orange"))

  #gráfico de torta (Watford)
pie(x = c(Watford_15$Porcentaje_Por_Partido, Watford_16$Porcentaje_Por_Partido),
    labels = c("", " "),
    col = c("green", "orange"),
    main = "% Puntos Obtenidos (Watford)")
text(0.0, 0.3, paste0(Watford_15$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)
text(0.3, -0.4, paste0(Watford_16$Porcentaje_Por_Partido, "%"), col = "black", cex = 0.9)

legend("topright", legend = c("2014-15", "2015-16"), fill = c("green", "orange"))

par(mfcol = c(1, 1))

  #eliminando variables ya no deseadas
remove(Bournemouth_15,Bournemouth_16, Burnley_15, Burnley_16, Hull_15, Hull_16, Norwich_15, Norwich_16, QPR_15, QPR_16, Watford_15, Watford_16)
```
...
```{r, echo=FALSE}
ggplot(Datos1, aes(x=total_puntos, y=Equipo, fill=VS)) + geom_col(color="black") + labs(x = "Puntos Acumulados") + ggtitle("Título") + theme(plot.title=element_text(hjust = 0.5, size=11)) + geom_text(aes(label=total_puntos), vjust=0, hjust=-0.3, size=3) + theme_bw()
...
```{r, echo=FALSE}
ggplot(Datos2, aes(x=total_puntos, y=Equipo, fill=VS)) + geom_col(color="black") + labs(x = "Puntos Acumulados") + ggtitle("Título") + theme(plot.title=element_text(hjust = 0.5, size=11)) + geom_text(aes(label=total_puntos), vjust=0, hjust=-0.3, size=3) + theme_bw()
...
g7 <-  ggplot(p_ath_a, aes(fill=Resultado, values=Total_Resultados)) + geom_waffle(n_rows=7, size=0.3, colour = "white") + scale_fill_manual(values=c("#BA182A", "#FF8288", "#FFDBDD")) + ggtitle("Ath Club de Bilbao (2017-18)")+ coord_equal() + theme_bw()

g8 <-  ggplot(p_ath_d, aes(fill=Resultado, values=Total_Resultados)) + geom_waffle(n_rows=7, size=0.3, colour = "white") + scale_fill_manual(values=c("#BA182A", "#FF8288", "#FFDBDD")) + ggtitle("Ath Club de Bilbao (2018-19)") + coord_equal() + theme_bw()
...
g9 <-  ggplot(p_celta_a, aes(fill=Resultado, values=Total_Resultados)) + geom_waffle(n_rows=7, size=0.3, colour = "white") + scale_fill_manual(values=c("#BA182A", "#FF8288", "#FFDBDD")) + ggtitle("RC Celta de Vigo (2017-18)")+ coord_equal() + theme_bw()

g10 <-  ggplot(p_celta_d, aes(fill=Resultado, values=Total_Resultados)) + geom_waffle(n_rows=7, size=0.3, colour = "white") + scale_fill_manual(values=c("#BA182A", "#FF8288", "#FFDBDD")) + ggtitle("RC Celta de Vigo (2018-19)") + coord_equal() + theme_bw()

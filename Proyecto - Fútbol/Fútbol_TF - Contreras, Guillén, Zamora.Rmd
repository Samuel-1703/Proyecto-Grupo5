...
Tomando en consideración que se tiene en estudio una base de datos relacionada con algunas ligas del fútbol europeo, que contiene información de partidos recopilados desde el año 2006 hasta el año 2021, y se puede apreciar quién jugaba de local, quién jugaba de visitante, los goles anotados y el equipo ganador; el presente trabajo estadístico tendrá como finalidad  analizar dicho comportamiento, tomando como puntos de partida situaciones que puedan conllevar una ventaja o desventaja a la hora de marcar goles o ganar encuentros para los equipos que se estudiarán a continuación.

...
# ¿Cuál fué el Efecto en la Consistencia Reflejada en la Cantidad de Goles en las Ligas Tras la Implementación del Video Assistant Referee (VAR)?
 ...
 Se procede a evaluar los goles anotados por 3 equipos de las ligas “Bundesliga” y “Laliga”, y comparar sus cambios una temporada antes y después la implementación oficial del VAR en sus respectivas divisiones de 1era.
...
```
 ...
 Específicamente hablando de la dispersión de los datos, independientemente de su mejoría o desmejoría a nivel de goles. Notemos que en estos tres equipos hubieron 2 de 3 (Friburgo y el Leverkusen) que aumentaron su desviación estándar con respecto a su media.  

* En el caso de Friburgo en pocas palabras, su concentración de datos del 50% bajó dos unidades, pasó a encontrarse entre los dos más bajos (0 y 1 goles). En definitiva empeoró
* En el caso de Leverkusen, su concentración de datos del 50% se mantuvo entre 1 y 2 goles, pero su mediana aumentó ligeramente. 
 ...
 Lo curioso de este caso es que 2 de los 3 equipos (Eintracht y el Leverkusen) evaluados en términos de goles han aumentado su rango de concentración de datos del 50% y su media, se dice que después de la inclusión del VAR les fue mejor anotando goles “válidos”.  
...
### Tabla de Posiciones - Bundesliga

 Estos casos tan “inesperados” inicialmente, de mejoría en estos 2 equipos, se deben a que eran equipos que venían de tener una temporada 2016-17 regular, pues habían quedado por detrás del 10mo lugar de toda la liga. Para en la entrante superar al menos 3 posiciones, quedando por arriba del 9no lugar.

 En el caso del equipo en desmejoría, pasó de quedar en el 7mo lugar en la temporada 2016-17 a quedar de 15vo lugar en la 2017-18.

![Tabla de Posición - Bundesliga]("C:\\Users\\guill\\Documents\\Trabajos\\Fútbol_TF - Repo\\Proyecto - Fútbol\\Imagenes Extras\\Dispersión Bundesliga.jpg"){width=90%}
...
Se puede decir en un principio que estos tres equipos no se vieron tan afectados en la liga.

### Tabla de Posiciones - Laliga

 Visualizando la tabla de posiciones de la temporada 2018-19, ya la temporada con el VAR incluido, nos encontramos que ciertamente 2 de los 3 equipos (Barcelona y el Sevilla) no tuvieron una diferencia significativa en las posiciones. Mientras que el otro equipo (Athletic de Bilbao) sorprendemente bajó 8 lugares en la tabla.

![Tabla de Posición - Laliga]("C:\\Users\\guill\\Documents\\Trabajos\\Fútbol_TF - Repo\\Proyecto - Fútbol\\Imagenes Extras\\Dispersión Laliga.jpg"){width=90%}
...
* CLUBES DE LA BUNDESLIGA 16/17. (s.f.). transfer markt. Recuperado de https://www.transfermarkt.es/bundesliga/startseite/wettbewerb/L1/plus/?saison_id=2016

* CLUBES DE LA BUNDESLIGA 17/18. (s.f.). transfer markt. Recuperado de https://www.transfermarkt.es/bundesliga/startseite/wettbewerb/L1/plus/?saison_id=2017

* CLUBES DE LA LALIGA 17/18. (s.f.). transfer markt. Recuperado de https://www.transfermarkt.es/laliga/startseite/wettbewerb/ES1/plus/?saison_id=2017

* CLUBES DE LA LALIGA 18/19. (s.f.). transfer markt. Recuperado de https://www.transfermarkt.es/laliga/startseite/wettbewerb/ES1/plus/?saison_id=2018

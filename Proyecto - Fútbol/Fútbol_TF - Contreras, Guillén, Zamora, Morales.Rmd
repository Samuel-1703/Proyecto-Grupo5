...
3) ¿Cuál fué el efecto reflejado en la cantidad de goles en las ligas tras la implementación del Video Assistant Referee (VAR)?
...
\pagebreak
# ¿Cuál fué el efecto reflejado en la cantidad de goles en las ligas tras la implementación del Video Assistant Referee (VAR)?
...
```{r Disp_bundes_boxplot, echo=FALSE}
g1 <- ggplot(var_bundes_antes, aes(x=Equipo, y=Goles_Pro, fill=Equipo)) + geom_jitter() + geom_boxplot() + scale_fill_manual(values=c("#CE93D8", "#7B1FA2", "#9C27BD"))+ labs(y="Goles Anotados") + scale_x_discrete("Equipos", labels = c("Eintracht", "Friburgo", "Leverkusen")) + theme_bw() + theme(legend.position = "none") 

g2 <- ggplot(var_bundes_despues, aes(x=Equipo, y=Goles_Pro, fill=Equipo)) + geom_jitter() + geom_boxplot() + scale_fill_manual(values=c("#CE93D8", "#7B1FA2", "#9C27BD"))+ labs(y="Goles Anotados") + scale_x_discrete("Equipos", labels = c("Eintracht", "Friburgo", "Leverkusen")) + theme_bw() + theme(legend.position = "none") 

plot_grid(g1, g2, nrow=1)

remove(var_bundes_antes, var_bundes_despues)
```

![Dispersión - Bundeliga]("C:\\Users\\guill\\Documents\\Trabajos\\Fútbol_TF - Repo\\Proyecto - Fútbol\\Imagenes Extras\\Dispersión Bundesliga.jpg"){width=90%}
...
```{r Disp_laliga_boxplot, echo=FALSE}
g1 <- ggplot(var_laliga_antes, aes(x=Equipo, y=Goles_Pro, fill=Equipo)) + geom_jitter() + geom_boxplot() + scale_fill_manual(values=c("#CE93D8", "#7B1FA2", "#9C27BD"))+ labs(x="Equipos", y="Goles Anotados") + theme_bw() + theme(legend.position = "none") 

g2 <- ggplot(var_laliga_despues, aes(x=Equipo, y=Goles_Pro, fill=Equipo)) + geom_jitter() + geom_boxplot() + scale_fill_manual(values=c("#CE93D8", "#7B1FA2", "#9C27BD")) + labs(x="Equipos", y="Goles Anotados") + theme_bw() + theme(legend.position = "none")

plot_grid(g1, g2, nrow=1)

remove(var_laliga_antes, var_laliga_despues, g1, g2)
```

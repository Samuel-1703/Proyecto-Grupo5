...
ggplot(v_ath, aes(x=Lugar, fill=Ganador)) + geom_bar(position="dodge",colour="black") + labs(y="Frecuencia") + ggtitle("Contador de Victorias en las posiciones - Athletic Club de Bilbao") + theme_test() + ylim(c(0,160)) + scale_fill_manual(values=c("#CE93D8", "#9C27BD", "#BA68CB")) + geom_text(aes(label=after_stat(count)), stat="count",
...
```{r Bar_frec_Mancherster, echo=FALSE}
ggplot(v_man, aes(x=Lugar, fill=Ganador)) + geom_bar(position="dodge",colour="black") + labs(y="Frecuencia") + ggtitle("Contador de Victorias en las posiciones - Manchester City") + theme_bw() +  scale_fill_manual(values=c("#CE93D8", "#9C27BD", "#BA68CB")) + geom_text(aes(label=after_stat(count)), stat="count",
                                                                        position=position_dodge(0.9),
                                                                        vjust=-0.3, 
                                                                        size=3.5)
```

...
ggplot(ath_plot, aes(x=Lugar, y=Total, fill=Ganador)) + geom_col(position="dodge",colour="black") + labs(y="Frecuencia") + ggtitle("Registro de Partidos - Athletic Club de Bilbao") + theme_test() + ylim(c(0,160)) + scale_fill_manual(values=c("#CE93D8", "#7B1FA2", "#9C27BD")) + theme(plot.title=element_text(hjust = 0.5, size=11)) +
...
ggplot(man_plot, aes(x=Lugar, y=Total, fill=Ganador)) + geom_col(position="dodge",colour="black") + labs(y="Frecuencia") + ggtitle("Registro de Partidos - Manchester City") + theme_test() + ylim(c(0,220)) + scale_fill_manual(values=c("#CE93D8", "#7B1FA2", "#9C27BD")) + theme(plot.title=element_text(hjust = 0.5, size=11)) + geom_text(aes(label=paste0(Total," ", "", "(", Porcentaje, "%", ")")),
         vjust=-0.5, 
         color="black", 
         hjust=0.5,
         position = position_dodge(0.9), 
...
g1 <- ggplot(var_bundes_antes, aes(x=Equipo, y=Goles_Pro, fill=Equipo)) + geom_jitter() + geom_boxplot() + scale_fill_manual(values=c("#CE93D8", "#7B1FA2", "#9C27BD")) + theme(legend.position = "none") +
 labs(x="Equipos", y="Goles Anotados")

g2 <- ggplot(var_bundes_despues, aes(x=Equipo, y=Goles_Pro, fill=Equipo)) + geom_jitter() + geom_boxplot() + scale_fill_manual(values=c("#CE93D8", "#7B1FA2", "#9C27BD")) + theme(legend.position = "none") +
 labs(x="Equipos", y="Goles Anotados")
...
g1 <- ggplot(var_laliga_antes, aes(x=Equipo, y=Goles_Pro, fill=Equipo)) + geom_jitter() + geom_boxplot() + scale_fill_manual(values=c("#CE93D8", "#7B1FA2", "#9C27BD")) + theme(legend.position = "none") +
 labs(x="Equipos", y="Goles Anotados")

g2 <- ggplot(var_laliga_despues, aes(x=Equipo, y=Goles_Pro, fill=Equipo)) + geom_jitter() + geom_boxplot() + scale_fill_manual(values=c("#CE93D8", "#7B1FA2", "#9C27BD")) + theme(legend.position = "none") +
 labs(x="Equipos", y="Goles Anotados")
...
* https://www.transfermarkt.es/bundesliga/startseite/wettbewerb/L1/plus/?saison_id=2016

* https://www.transfermarkt.es/bundesliga/startseite/wettbewerb/L1/plus/?saison_id=2017
